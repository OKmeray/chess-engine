...
from core.domain.engine.square_helping_functions import get_bitboard_from_num, get_nums_from_bit_nums
from core.domain.evaluation.evaluation import evaluate_position, PieceEnum, PieceColor, CastleEnum
from core.domain.moves.GenerateMove import GenerateMove
...
class Position:
    ...
    def get_all_moves(self):
        ...
        return list(legal_moves)[::-1]

    def get_moves_sorted_by_priority(self):
        separate_moves = self.get_all_separate_moves()

        new_separate_moves = []
        for move in separate_moves:
        ...
        for piece in all_pseudo_legal_moves:
            for move in piece['possible_moves']:
                try:
                    ...
                    print(str(e), piece, "IS HERE", self.get_all_bitboard())  # , self.get_all_moves())
        return False
